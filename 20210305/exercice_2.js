...
console.log('Ville de plus de 30000 habitants', villes)
...
const habitantsYverdon = villes.filter(v => v.nom === 'Yverdon')[0].population;

console.log('Nombre d\'habitants à Yverdon', habitantsYverdon);

// 30143

const somme = (total, ville) => ville.population + total;

const sommeHabitants = villes.reduce(somme, 0);
